...
#PBS -N  svCapture_find_tagmentation
...
#PBS -V  
#PBS -W depend=afterok:36975612

# Slurm directives
#SBATCH --job-name=svCapture_find_tagmentation
...
#SBATCH --export=ALL  
#SBATCH --dependency=afterok:36975612
