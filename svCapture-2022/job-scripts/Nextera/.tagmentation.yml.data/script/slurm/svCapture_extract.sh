...
#SBATCH --output=/nfs/turbo/path-wilsonte-turbo/mdi/wilsontelab/greatlakes/data-scripts/wilsontelab/publications/svCapture-2022/job-scripts/Nextera/.tagmentation.yml.data/log/slurm/%x.o%A-%a
#SBATCH --account=wilsonte0
#SBATCH --mail-user=nobody\@nowhere.edu
#SBATCH --mail-type=NONE
#SBATCH --export=ALL 
#SBATCH --array=1-3 
#SBATCH --dependency=afterok:36975609
